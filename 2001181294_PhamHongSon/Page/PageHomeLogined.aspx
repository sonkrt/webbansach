<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="PageHomeLogined.aspx.cs" Inherits="Page_PageHomeLogined" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="gioHang">
            <ul>
                ...
                <li>
                    ...
                    <asp:Button ID="btTimTheoGia" runat="server" Text="Tìm" OnClick="btTimTheoGia_Click" ValidationGroup="TTG" />
                        </div>
                </li>
    ...
    <div>
        <asp:DataList ID="DataListTatCaSP" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" OnItemCommand="DataListTatCaSP_ItemCommand">
            <ItemTemplate>
                <table class="tdSP" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                        <td >
                            <asp:Button ID="Button1" runat="server" Text="Thêm sách" CommandName="chonmua" CommandArgument='<%# Eval("MASACH") %>' OnClick="Button1_Click"/>
                        </td>
                        <td>
